        ...
        <div className="p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full py-3 sm:py-4 px-6 text-black bg-white hover:bg-gray-50 border border-black/20 rounded-lg sm:rounded-xl transition-all duration-200 font-medium shadow-sm active:scale-95 flex items-center justify-center space-x-3"
                style={{
                  fontSize: 'clamp(14px, 3vw, 16px)',
                  fontFamily: 'Outreque, sans-serif',
                  minHeight: '48px'
              ...
              <button
                type="button"
                className="w-full py-3 sm:py-4 px-6 text-white bg-gray-900 hover:bg-gray-800 rounded-lg sm:rounded-xl transition-all duration-200 font-medium shadow-sm active:scale-95 flex items-center justify-center space-x-3"
                style={{
                  fontSize: 'clamp(14px, 3vw, 16px)',
                  fontFamily: 'Outreque, sans-serif',
                  minHeight: '48px'
